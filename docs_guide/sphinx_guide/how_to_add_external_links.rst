...
In order to link to an external page you have to write ```text of your link <your_url>`_``. For example, you can link to `IBM Quantum documentation <https://quantum.cloud.ibm.com/docs>`_ by writing:
...
If your file is a Jupyter notebook, what you have to write to link to a page is ``[text of your link](your_url)``. If you want to link to `IBM Quantum Documentation <https://quantum.cloud.ibm.com/docs>`_ you can write:
