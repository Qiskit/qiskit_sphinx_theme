...
def setup(app: sphinx.application.Sphinx) -> None:
    app.add_directive(CustomCardItemDirective.NAME, CustomCardItemDirective)
    app.add_directive(CustomCalloutItemDirective.NAME, CustomCalloutItemDirective)
